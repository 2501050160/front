                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                    ...
                                                                    {isPendingScan ? (
                                                                        <div className={`rounded-2xl border px-3 py-2 shadow-lg ${palette.chip} ${palette.glow} flex flex-row items-center justify-center gap-4`}>
                                                                            ...
                                                                            <div className="h-16 w-56 shrink-0 rounded-lg overflow-hidden border border-white/20 bg-white p-1">
                                                                                <img 
                                                                                    src={`https://quickchart.io/barcode?type=code128&text=${order.orderId}-${order.otpCode}&includeText=false&height=70`} 
                                                                                    alt="Barcode"
                                                                ...
                                                                <div className="relative text-right">
                                                                    ...
                                                                    <p className="mt-1 text-[10px] font-black uppercase tracking-wider text-white/50">pages</p>
                                                                </div>
                                                            </motion.div>
                                                        );
                                                    })}
