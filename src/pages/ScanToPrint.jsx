                ...
                {verifyingOrder && (
                    ...
                    >
                        ...
                        >
                            ...
                            {/* Modal Body: Single Unified Section for Camera + OTP */}
                            <div className="px-5 pt-4 pb-5 space-y-4 max-h-[85vh] overflow-y-auto">
                                {/* Single Unified Container for Camera Scanner & OTP Display */}
                                <div className="rounded-2xl border border-cyan-500/30 bg-black/60 p-3 space-y-3 shadow-inner">
                                    {/* Camera Scanner View */}
                                    <OtpBarcodeScanner
                                        ...
                                        onResult={(decoded) => {
                                            ...
                                            if (matchingOrder) {
                                                ...
                                                setMobileOtpError(
                                                    scannedOrderId 
                                                        ? `⚠️ Order ${scannedOrderId} does not belong to your account (${currentUserEmail}).`
                                                        : `⚠️ Scanned barcode is not valid for any of your pending jobs.`
                                                );
                                            }
                                        }}
                                    />

                                    {/* Embedded OTP Digits Display Field */}
                                    <div className="pt-2 border-t border-white/10 flex flex-col items-center">
                                        <p className="text-[10px] font-black uppercase tracking-widest text-cyan-400 mb-1.5">
                                            Scan Barcode OR Enter 4-Digit OTP
                                        </p>
                                ...
                                {mobileOtpError && (
                                    <p className="text-xs font-bold text-rose-400 bg-rose-500/10 border border-rose-500/20 py-2 px-3 rounded-xl text-center">
                                        ⚠️ {mobileOtpError}
                                    </p>
                                )}
